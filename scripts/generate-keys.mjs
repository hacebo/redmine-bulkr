...
const appCookieSecret = crypto.randomBytes(32).toString('hex');
const cryptoKey = crypto.randomBytes(32).toString('base64');
const redisHashSecret = crypto.randomBytes(32).toString('hex');

console.log('Add these to your .env.local file:\n');
console.log('# App session cookie secret (32 bytes in hex)');
console.log(`APP_COOKIE_SECRET="${appCookieSecret}"`);
console.log('');
